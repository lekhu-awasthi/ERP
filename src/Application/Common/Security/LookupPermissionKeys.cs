...
public static class LookupPermissionKeys
{
    public static string ViewKeyFor<TLookup>() where TLookup : class, ITenantLookupEntity =>
        typeof(TLookup) switch
        {
            ...
            var t when t == typeof(CostTerm) => PermissionKeys.CostTermView,
            ...
            var t when t == typeof(Currency) => PermissionKeys.CurrencyView,
            ...
            var t when t == typeof(AlertDefinition) => PermissionKeys.AlertDefinitionView,
    ...
    public static string ManageKeyFor<TLookup>() where TLookup : class, ITenantLookupEntity =>
        typeof(TLookup) switch
        {
            ...
            var t when t == typeof(CostTerm) => PermissionKeys.CostTermManage,
            ...
            var t when t == typeof(Currency) => PermissionKeys.CurrencyManage,
            ...
            var t when t == typeof(AlertDefinition) => PermissionKeys.AlertDefinitionManage,
