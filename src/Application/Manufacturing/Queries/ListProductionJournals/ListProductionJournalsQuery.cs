...
public sealed record ListProductionJournalsQuery(
    ...
    : IRequest<PagedResult<ProductionJournalListItemDto>>, IRequirePermission, IOrganizationScoped, IRequireFeature, ILocationFilteredQuery, ISearchableQuery, IDateRangeFilteredQuery
{
