...
public sealed class UpdateProductionJournalCommandValidator : AbstractValidator<UpdateProductionJournalCommand>
{
    public UpdateProductionJournalCommandValidator()
    {
