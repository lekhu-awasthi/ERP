...
public sealed record UpdateBillOfMaterialsCommand(
    Guid OrganizationId,
    Guid Id,
    Guid ProductId,
    ...
    : IRequest<UpdateBillOfMaterialsResult>, IRequirePermission, IOrganizationScoped, IRequireFeature
{
...
public sealed record UpdateBillOfMaterialsResult(Guid Id);
