...
public sealed class UpdateGoodsReceivedNoteCommandValidator : AbstractValidator<UpdateGoodsReceivedNoteCommand>
{
    public UpdateGoodsReceivedNoteCommandValidator()
    {
