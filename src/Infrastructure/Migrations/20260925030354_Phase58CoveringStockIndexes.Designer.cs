...
namespace ErpApp.Infrastructure.Migrations
{
    ...
    [Migration("20260925030354_Phase58CoveringStockIndexes")]
    partial class Phase58CoveringStockIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpApp.Domain.Accounting.GlJournalEntry", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("OrganizationId", "PostedAt"), new[] { "SourceDocumentType", "SourceDocumentId" });
            ...
            modelBuilder.Entity("ErpApp.Domain.Accounting.GlLine", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AccountId"), new[] { "GlJournalEntryId", "Debit", "Credit", "ReconciliationId" });
            ...
            modelBuilder.Entity("ErpApp.Domain.Configuration.AlertDefinition", b =>
                {
                    ...
                    b.ToTable("AlertDefinitions", "configuration");
                });

            modelBuilder.Entity("ErpApp.Domain.Configuration.AlertSendLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AlertDefinitionId", "OccurrenceDate", "Recipient")
                        .IsUnique();

                    b.ToTable("AlertSendLogs", "configuration");
                });
            ...
            modelBuilder.Entity("ErpApp.Domain.Identity.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganizationId", "UserId", "Key")
                        .IsUnique();
            ...
            modelBuilder.Entity("ErpApp.Domain.Imports.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ImportJobs", "imports");
                });

            modelBuilder.Entity("ErpApp.Domain.Imports.ImportJobRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ErpApp.Domain.Payments.Cheque", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "ChequeDate")
                        .IsDescending(false, true);
            ...
            modelBuilder.Entity("ErpApp.Domain.Purchasing.PurchaseBill", b =>
                {
                    ...
                    b.Property<decimal?>("AdditionalCostRoundingAdjustment")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal?>("CapitalisedAdditionalCost")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<bool>("IsProductWiseAdditionalCost")
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("ErpApp.Domain.Purchasing.PurchaseBillAdditionalCost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PurchaseBillAdditionalCosts", "purchasing");
                });

            modelBuilder.Entity("ErpApp.Domain.Purchasing.PurchaseBillAdditionalCostAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PurchaseBillAdditionalCostId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PurchaseBillLineId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("PurchaseBillAdditionalCostId");

                    b.HasIndex("PurchaseBillLineId");

                    b.ToTable("PurchaseBillAdditionalCostAllocations", "purchasing");
                });
            ...
            modelBuilder.Entity("ErpApp.Domain.Tenancy.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001c1"),
                            IsGranted = true,
                            PermissionKey = "Tenancy.Organization.BackfillLocations",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001c2"),
                            IsGranted = false,
                            PermissionKey = "Tenancy.Organization.BackfillLocations",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000131"),
                            IsGranted = true,
                            PermissionKey = "Tenancy.Subscription.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000132"),
                            IsGranted = true,
                            PermissionKey = "Tenancy.Subscription.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000133"),
                            IsGranted = true,
                            PermissionKey = "Configuration.AlertDefinition.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000134"),
                            IsGranted = true,
                            PermissionKey = "Configuration.AlertDefinition.Manage",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000135"),
                            IsGranted = false,
                            PermissionKey = "Configuration.AlertDefinition.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000136"),
                            IsGranted = false,
                            PermissionKey = "Configuration.AlertDefinition.Manage",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000137"),
                            IsGranted = true,
                            PermissionKey = "Configuration.AlertSendLog.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000138"),
                            IsGranted = false,
                            PermissionKey = "Configuration.AlertSendLog.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-000000000139"),
                            IsGranted = true,
                            PermissionKey = "Configuration.ImportJob.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-00000000013a"),
                            IsGranted = true,
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-00000000013b"),
                            IsGranted = false,
                            PermissionKey = "Configuration.ImportJob.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001a7"),
                            IsGranted = true,
                            PermissionKey = "Tenancy.Currency.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001a8"),
                            IsGranted = true,
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001a9"),
                            IsGranted = true,
                            PermissionKey = "Tenancy.Currency.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001b9"),
                            IsGranted = true,
                            PermissionKey = "Platform.GlobalSearch.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000001")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001ba"),
                            IsGranted = true,
                            PermissionKey = "Platform.GlobalSearch.View",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001bb"),
                            IsGranted = true,
                        ...
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0002-0000000001bc"),
                            IsGranted = true,
                            PermissionKey = "Platform.UserPreference.Manage",
                            RoleId = new Guid("00000000-0000-0000-0001-000000000002")
                        },
            ...
            modelBuilder.Entity("ErpApp.Domain.Tenancy.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DailyAiScanQuota")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DeveloperApiIncluded")
                        .HasColumnType("bit");

                    b.Property<int>("DisplayOrder")
                        .HasColumnType("int");

                    b.Property<bool>("LandedCostIncluded")
                        .HasColumnType("bit");

                    b.Property<bool>("ManufacturingIncluded")
                        .HasColumnType("bit");

                    b.Property<bool>("MultiCurrencyIncluded")
                        .HasColumnType("bit");

                    b.Property<bool>("MultipleWarehousesIncluded")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PosIncluded")
                        .HasColumnType("bit");

                    b.Property<int>("ProductQuota")
                        .HasColumnType("int");

                    b.Property<bool>("TrackInventoryIncluded")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "Basic",
                            DailyAiScanQuota = 20,
                            Description = "Best for service based businesses that require basic accounting",
                            DeveloperApiIncluded = false,
                            DisplayOrder = 1,
                            LandedCostIncluded = false,
                            ManufacturingIncluded = false,
                            MultiCurrencyIncluded = true,
                            MultipleWarehousesIncluded = false,
                            Name = "Basic",
                            PosIncluded = false,
                            ProductQuota = 1000,
                            TrackInventoryIncluded = false,
                            TransactionQuota = 30000
                        },
                        new
                        {
                            ...
                            Code = "Standard",
                            DailyAiScanQuota = 20,
                            Description = "Best for SME organizations that require accounting & inventory tracking",
                            DeveloperApiIncluded = false,
                            DisplayOrder = 2,
                            LandedCostIncluded = true,
                            ManufacturingIncluded = false,
                            MultiCurrencyIncluded = true,
                            MultipleWarehousesIncluded = true,
                            Name = "Standard",
                            PosIncluded = false,
                            ProductQuota = 5000,
                            TrackInventoryIncluded = true,
                        ...
                        new
                        {
                            ...
                            Code = "Professional",
                            DailyAiScanQuota = 20,
                            Description = "Best for Retail/Restaurants that require POS along with accounting & inventory tracking",
                            DeveloperApiIncluded = true,
                            DisplayOrder = 3,
                            LandedCostIncluded = true,
            ...
            modelBuilder.Entity("ErpApp.Domain.Tenancy.TenantSettings", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultForexGainAccountId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultForexLossAccountId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DefaultLandedCostClearingAccountId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ErpApp.Domain.Tenancy.TenantSubscription", b =>
                {
                    ...
                    b.Property<bool>("IrdVerified")
                        .HasColumnType("bit");

                    b.Property<int>("LocationQuota")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErpApp.Domain.Imports.ImportJobRow", b =>
                {
                    b.HasOne("ErpApp.Domain.Imports.ImportJob", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ErpApp.Domain.Purchasing.PurchaseBillAdditionalCostAllocation", b =>
                {
                    b.HasOne("ErpApp.Domain.Purchasing.PurchaseBillAdditionalCost", null)
                        .WithMany("Allocations")
                        .HasForeignKey("PurchaseBillAdditionalCostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ErpApp.Domain.Purchasing.PurchaseBillLine", null)
                        .WithMany()
                        .HasForeignKey("PurchaseBillLineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ErpApp.Domain.Tenancy.TenantSubscription", b =>
                {
                    ...
                    b.HasOne("ErpApp.Domain.Tenancy.SubscriptionPlan", null)
                        .WithMany()
