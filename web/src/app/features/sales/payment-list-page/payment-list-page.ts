...
export class PaymentListPage {
  ...
  private load(): void {
    ...
    this.paymentsService
      .listPayments(this.organizationId, status === 'All' ? undefined : status, 'Received', this.page(), this.pageSize(), this.filter.options())
      .subscribe({
        next: (result) => {
   ...
   */
  protected readonly sortOptions = documentSortOptions('Payment date');
