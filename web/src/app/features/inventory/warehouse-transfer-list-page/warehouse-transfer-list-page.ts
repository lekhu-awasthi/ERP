...
export class WarehouseTransferListPage {
  ...
  private load(): void {
    ...
    this.inventoryService
      .listWarehouseTransfers(this.organizationId, status === 'All' ? undefined : status, this.page(), this.pageSize(), this.filter.options())
      .subscribe({
        next: (result) => {
   ...
   */
  protected readonly sortOptions = documentSortOptions('Transfer date');
