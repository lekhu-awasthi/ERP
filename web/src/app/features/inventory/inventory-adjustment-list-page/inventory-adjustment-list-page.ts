...
export class InventoryAdjustmentListPage {
  ...
  private load(): void {
    ...
    this.inventoryService
      .listInventoryAdjustments(this.organizationId, status === 'All' ? undefined : status, this.page(), this.pageSize(), this.filter.options())
      .subscribe({
        next: (result) => {
   ...
   */
  protected readonly sortOptions = documentSortOptions('Adjustment date');
